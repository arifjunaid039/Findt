...
<head>
    ...
    <title>BackToYou | Claim Item</title>
    ...
    <style>
        ...
        :root{
            ...
            --card-shadow:0 15px 45px rgba(59,130,246,.1);
            --hairline:rgba(59,130,246,.08);
        ...
        *{
        ...
        @media (max-width: 575.98px){
            .claim-page{ width:100%; margin:20px auto; padding:0 14px; }
            .claim-card{ border-radius:16px; }

            .claim-header{ padding:18px; gap:12px; }
            .claim-photo,
            .claim-placeholder{ width:60px; height:60px; border-radius:12px; font-size:24px; }
            .claim-title{ font-size:18px; }
            .status-pill{ font-size:11px; padding:4px 11px; }

            .claim-details{ padding:16px 18px; }
            .claim-details .detail-row{ font-size:13.5px; }
            .claim-details .desc-text{ font-size:13.5px; }

            .claim-body{ padding:32px 18px; }
            .claim-body .icon-wrap{ width:60px; height:60px; margin-bottom:14px; }
            .claim-body .icon-wrap i{ font-size:26px; }
            .claim-body h4{ font-size:16px; }
            .claim-body p{ font-size:13.5px; }
