...
<title>BackToYou | Privacy Policy</title>
...
<div class="wrap">
    ...
    <div class="subtitle">How BackToYou collects, uses, and protects your information.</div>
    ...
    <div class="layout">
        ...
        <div class="content">
            ...
            <div class="term-card" id="intro">
                ...
                <p>This Privacy Policy explains how BackToYou ("we", "us", "our") collects, uses, and protects your personal information when you use our lost &amp; found platform. By using BackToYou, you agree to the practices described in this policy.</p>
                <p>We built BackToYou to help people in Pakistan reconnect with their lost belongings, and we take the privacy of your data seriously throughout that process.</p>
            </div>
            ...
            <div class="term-card" id="use">
                ...
                <ul>
                    <li>To create and manage your BackToYou account.</li>
            ...
            <div class="term-card" id="messaging">
                ...
                <p>Messages sent through BackToYou's chat system are stored so that conversations can be retrieved by both participants and reviewed if a report or block is filed. We do not routinely monitor private conversations, but reported chats may be reviewed by our team to investigate abuse, harassment, or fraud.</p>
            ...
            <div class="term-card" id="cookies">
                ...
                <p>BackToYou uses cookies and similar technologies to keep you logged in, remember your theme preference (light/dark mode), and understand how the platform is used. You can control cookies through your browser settings, though disabling them may affect certain features.</p>
            </div>
            ...
            <div class="term-card" id="children">
                ...
                <p>BackToYou is not intended for children under 13 years of age, and we do not knowingly collect personal information from children under 13. If we become aware that we have collected data from a child under 13, we will take steps to delete it.</p>
            </div>

            <div class="term-card" id="changes">
                <div class="term-icon"><i class="fa-solid fa-rotate text-primary"></i></div>
                <h2>11. Changes to This Policy</h2>
                <p>We may update this Privacy Policy from time to time to reflect changes in our practices or legal requirements. Continued use of BackToYou after changes are posted constitutes your acceptance of the updated policy. Significant changes will be communicated through the platform where possible.</p>
            </div>
