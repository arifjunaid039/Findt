...
<head>
    ...
    <title>FindIT | Found Items</title>
    ...
    <style>
    /* ===== Search + Filter bar (scoped so it won't clash with Founditems.css) ===== */
    .search-filter-bar{
        max-width:1200px;
        margin:0 auto 24px;
        padding:0 16px;
...
<script>
    // ===== Search + Filter logic (vanilla JS) =====
    (function(){
        ...
        // If we arrived here from a category card (e.g. Founditems?category=keys),
        // pre-select that filter chip on load.
