...
<form action="{{ url('/register') }}"
    ...
    <div class="ticket-head">
        ...
        <div class="stamp-seal">
            <img src="{{ asset('img/Logo.jpeg') }}" alt="FindIT">
        </div>
        ...
        <div class="input-group">
            ...
            <div class="photo-upload">
                ...
                <div class="photo-upload-text">
                    ...
                    <strong>Upload CNIC Photo</strong>

                    <span>Front side only, clearly legible</span>
...
<script>
    ...
    const cnicPhotoPreview=document.getElementById("cnicPhotoPreview");
    ...
    cnicPhotoPreview.src=URL.createObjectURL(file);
