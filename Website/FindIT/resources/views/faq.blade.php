  ...
  <title>FAQ — FindIT</title>
  <meta name="description" content="Answers to common questions about reporting lost or found items, submitting claims, chatting safely, and joining communities on FindIT.">
  ...
  <script type="application/ld+json">
  {
    ...
    "@type": "FAQPage",
    "mainEntity": [
      {"@type":"Question","name":"What is FindIT?","acceptedAnswer":{"@type":"Answer","text":"FindIT is a lost-and-found platform for Pakistan where you can report lost items, report found items, search listings, submit claim requests, chat with the owner or finder after a claim, and join university or community lost-and-found groups."}},
      ...
      {"@type":"Question","name":"Do I need to pay anything to claim my item?","acceptedAnswer":{"@type":"Answer","text":"No. You should never pay money to claim an item on FindIT."}}
    ]
  }
  </script>
  @endverbatim
...
[data-bs-theme="dark"] .safety-strip strong{
  ...
  @include('nav')
    ...
    <div class="faq-hero">
      ...
      <p>Everything you need to know about reporting, searching, claiming, and recovering items on FindIT.</p>
    ...
    <div class="glass safety-strip">
      ...
      <p><strong>Stay safe:</strong> always meet in a public place, verify ownership before handing an item over, and never share your password, OTP, PIN, or banking details in chat. FindIT never asks you to pay to claim an item.</p>
    </div>
  ...
  function faqPage(){
    return {
      ...
      faqs: [
        {cat:'Getting Started', q:'What is FindIT?', a:'FindIT is a lost-and-found platform for Pakistan where you can report lost items, report found items, search listings, submit claim requests, chat with the owner or finder after a claim, and join university or community lost-and-found groups.'},
        ...
        {cat:'Reporting & Searching', q:'What item categories does FindIT support?', a:'FindIT covers a wide range of personal belongings, including mobile phones, laptops, wallets, ID cards, passports, keys, bags, books, watches, glasses, jewelry, documents, chargers, earbuds, clothing, and other personal items.'},
        ...
        {cat:'Chat & Safety', q:'Should I share personal info like OTP or passwords in chat?', a:'No, never share your password, OTP, PIN, or banking information with anyone on FindIT, including someone claiming to be the finder or owner.'},

        {cat:'Communities', q:'What are FindIT communities?', a:'Communities are groups such as universities, colleges, schools, and organizations. Members of a community can report and search for items specifically within that group.'},
