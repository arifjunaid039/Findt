...
<head>
    ...
    <title>FindIT | Community Manage Profile</title>
...
<div class="container">
    ...
    <form method="POST" action="/community/profile/update" enctype="multipart/form-data">
        ...
        <div class="form-area">
            ...
            <div class="form-row">
                ...
                <div class="form-group">
                    ...
                    <div class="input-wrap">
                        ...
                        <input type="text" id="location" name="location" value="{{ old('location', $community->location) }}" placeholder="e.g. Dolmen Mall">
                    </div>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="input-wrap">
                    <span class="icon-chip icon-privacy"><i class="fa-solid fa-eye"></i></span>
                    <select id="privacy" name="privacy">
                        <option value="Public" {{ old('privacy', $community->privacy)=='Public'?'selected':'' }}>Public — anyone can find and join</option>
                        <option value="Private" {{ old('privacy', $community->privacy)=='Private'?'selected':'' }}>Private — join by approval only</option>
                    </select>
                </div>
            </div>
    ...
    <div class="danger-section">
        ...
        <form method="POST" action="/community/profile/delete" id="deleteForm">
            @csrf
            <div class="form-group">
                <label for="delete_confirm">Type <strong>{{ $community->name }}</strong> to confirm</label>
                <input type="text" id="delete_confirm" name="confirm_name" placeholder="{{ $community->name }}" autocomplete="off">
            </div>
