...
<title>FindIT | Terms &amp; Conditions</title>
...
<div class="wrap">
    ...
    <div class="subtitle">Please read these terms carefully before using FindIT.</div>
    ...
    <div class="layout">
        ...
        <div class="content">
            ...
            <div class="term-card" id="acceptance">
                ...
                <p>By creating an account or using FindIT in any way, you agree to be bound by these Terms &amp; Conditions and our Privacy Policy. If you do not agree with any part of these terms, please do not use the platform.</p>
                <p>FindIT is intended for users located in Pakistan and is designed to help people report, search for, and reclaim lost belongings within their community.</p>
            </div>
            ...
            <div class="term-card" id="accounts">
                ...
                <ul>
                    ...
                    <li>You must be at least 13 years old to create an account on FindIT.</li>
            ...
            <div class="term-card" id="items">
                ...
                <ul>
                    ...
                    <li><strong>Claim requests:</strong> Claimants must provide sufficient proof of ownership before a claim is approved. FindIT does not guarantee the return of any item and is not a party to the exchange itself.</li>
                    ...
                    <li>FindIT is not responsible for verifying the legal ownership of any item posted or claimed on the platform.</li>
                </ul>
            </div>
            ...
            <div class="term-card" id="conduct">
                ...
                <p>While using FindIT, you agree not to:</p>
                <ul>
            ...
            <div class="term-card" id="content">
                ...
                <p>You retain ownership of any photos, descriptions, and other content you upload to FindIT. By posting content, you grant FindIT a limited, non-exclusive license to display, store, and distribute that content within the platform for the purpose of operating the service.</p>
            ...
            <div class="term-card" id="liability">
                ...
                <ul>
                    <li>FindIT is a platform that connects people who have lost items with people who have found them — we do not guarantee the recovery, authenticity, or condition of any item.</li>
                    ...
                    <li>To the maximum extent permitted by law, FindIT and its team shall not be liable for any indirect, incidental, or consequential damages arising from your use of the service.</li>
                </ul>
            </div>
            ...
            <div class="term-card" id="changes">
                ...
                <p>We may update these Terms &amp; Conditions from time to time to reflect changes in our platform or legal requirements. Continued use of FindIT after changes are posted constitutes your acceptance of the updated terms. Significant changes will be communicated through the platform where possible.</p>
            </div>
