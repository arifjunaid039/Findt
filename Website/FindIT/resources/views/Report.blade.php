...
<head>
    ...
    <style>
        /* --- Added validation styles (move into reportitem.css if you prefer) --- */
...
<input 
    ...
    <div class="form-group">
        ...
        <div class="form-group" id="group-location">
            ...
            <input type="text" name="location" id="location" value="{{ old('location') }}" placeholder="e.g. Gulshan-e-Iqbal, Karachi" required>
            <span class="field-error-msg" id="err-location" style="display:none;">Please enter a location.</span>
        </div>
...
<script>
    ...
    function currentCategoryName() {
        ...
        return selectedOption ? selectedOption.dataset.name : null;
    }
