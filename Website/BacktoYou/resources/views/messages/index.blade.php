...
/* ---------- large desktop: keep more breathing room ---------- */
@media(min-width:1600px){
    .page-wrap{ max-width:1400px; }
}

/* ---------- small laptop / tablet landscape: trim sidebar so chat
   never gets squeezed, before we fully collapse to mobile ---------- */
@media(max-width:1100px) and (min-width:901px){
    .sidebar{ width:300px; }
}

/* ---------- tablet portrait: narrower sidebar, tighter paddings,
   still two-column since there's enough width for both panes ---------- */
@media(max-width:900px) and (min-width:769px){
    .page-wrap{ width:97%; margin:20px auto; }
    .sidebar{ width:270px; }
...
/* ---------- collapse to WhatsApp-mobile style ---------- */
...
/* ---------- short / landscape phones: shrink vertical chrome so the
   whole shell stays visible without scrolling the page ---------- */
@media(max-width:900px) and (max-height:480px){
    .page-wrap{ margin:8px auto; }
    .page-title{ display:none; }
    .app-shell{ height:94vh; height:94dvh; min-height:320px; }
...
@media(max-width:400px){
    ...
    .search-bar input{ font-size:13px; padding:9px 12px 9px 34px; }
    .filter-btn{ font-size:12px; padding:6px 10px; }
    .convo-photo, .convo-placeholder{ width:42px; height:42px; }
    .convo-item{ padding:11px 12px; gap:10px; }
    .chat-form{ padding:6px 6px 6px 12px; }
...
@media(max-width:340px){
    ...
    .claim-link{ font-size:12px; }
    .status-pill{ font-size:10.5px; padding:3px 9px; }
}
</style>
