...
<title>FindIT | Claim Requests</title>
...
@media (max-width: 767.98px){
    .wrap{ width:96%; margin:36px auto; }
...
@media(max-width:576px){
    ...
    .claim-card{ flex-direction:column; padding:16px; }
    .item-photo, .item-placeholder{ width:100%; height:120px; }
    ...
    .filter-btn{ flex:1; text-align:center; padding:8px 10px; }
}
    ...
    @forelse($claims as $claim)
        ...
        <div class="claim-card" data-status="{{ $claim->status }}">
            ...
            <div class="card-body">
                ...
                <div class="top-row">
                    <div class="item-title">{{ $claim->title }}</div>
