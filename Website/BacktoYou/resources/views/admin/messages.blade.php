@extends('admin.layout')
  ...
  <style>
    ...
    /* Hidden by default: only shown once .col-subject itself disappears
       (see the 767.98px media query below), so the subject line never
       renders twice while the real Subject column is still on screen. */
    .msg-meta .meta-subject{ display:none; }
